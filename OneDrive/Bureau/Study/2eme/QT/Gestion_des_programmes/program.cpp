...
{
    QSqlQuery query,query2;
    QString squery="SELECT * from PROGRAMMES WHERE nom_p  LIKE'%"+rech+"' OR acteur LIKE'%"+rech+"%' OR id_p LIKE'%"+rech+"%' OR date_p LIKE'%"+rech+"%' OR heure_p LIKE'%"+rech+"%' OR id_s LIKE'%"+rech+"%'";
   QString squery2=" INSERT INTO HYSTORY SELECT id_p ,id_s,nom_p,acteur,date_p,heure_p,views,'recherche' from PROGRAMMES WHERE nom_p  LIKE'%"+rech+"%' OR acteur LIKE'%"+rech+"%' OR id_p LIKE'%"+rech+"%' OR date_p LIKE'%"+rech+"%' OR heure_p LIKE'%"+rech+"%' OR id_s LIKE'%"+rech+"%' ";
   QSqlQueryModel*model=new QSqlQueryModel();
