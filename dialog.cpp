...
/*void Dialog::on_pushButton_clicked()
{
        ...
        QSqlQuery query,query1,query2,query3;
            ...
            query1.prepare("SELECT * FROM INVITER where age >25 and AGE<35") ;
            query1.exec();
            while(query1.next())
            {
                    c1++ ;
            ...
            query2.prepare("SELECT * FROM INVITER where AGE >35 and AGE<45 ") ;
            query2.exec();
            while(query2.next())
            {
                    c2++ ;
            ...
            query3.prepare("SELECT * FROM INVITER where AGE >45") ;
            query3.exec();
            while(query3.next())
            {
                    c3++ ;
